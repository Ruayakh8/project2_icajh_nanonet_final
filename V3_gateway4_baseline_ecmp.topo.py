...
class V3_gateway4_baseline_ecmp(Topo):
    def build(self):
        self.add_node('0')
        self.add_node('1')
        self.add_node('2')
        ...
        self.add_link_name('2', '3', cost=1000, delay=0.2, bw=4000000, directed=True)
        self.add_link_name('3', '2', cost=1000, delay=0.2, bw=4000000, directed=True)
        self.add_link_name('0', '4', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('1', '4', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('2', '4', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('3', '4', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('4', '0', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('4', '1', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('4', '2', cost=1000, delay=0.2, bw=12000, directed=True)
        self.add_link_name('4', '3', cost=1000, delay=0.2, bw=12000, directed=True)
        ...
        self.add_link_name('0', '12', cost=1000, delay=0.2, bw=1000000, directed=True)
...
topos = {'V3_gateway4_baseline_ecmp': (lambda: V3_gateway4_baseline_ecmp())}
